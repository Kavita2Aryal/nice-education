            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-outline-primary btn-xs float-right" onclick="window.location.href='{{route('news.index')}}';" data-toggle="tooltip" data-placement="bottom"  title="News List"> <i class="icon-list"></i> </button>

                    </div>
                    <div class="card-body">
                        <form class="row cmxform" id="parsleyValidationForm" method="post" action="{{route('news.store')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- bootstrap-imageupload. -->
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input  class="form-control" name="video_link" type="text" data-parsley-trigger="keyup"  required data-parsley-required-message= "*The slug field is required.">
                            </div>
