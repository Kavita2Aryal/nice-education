<div class="row">
    ...
    <div class="form-group col-md-12">
        ...
        <input id="popular_course_title" type="text" class="form-control" name="popular_course_title" value="{{$study->popular_course_title}}" required>
    </div>

    <div class="form-group col-md-12">
        <label for="popular_course_description"> Popular Course - Section Description </label>
        <textarea name="popular_course_description" class="summernoteEditor"  cols="30" rows="5" required> {{ $study->popular_course_description }} </textarea>
    </div>
