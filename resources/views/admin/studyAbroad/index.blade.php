                                ...
                                <div class="table-responsive">
                                    <table id="order-listing" class="table">
                                        ...
                                        @foreach($countries as $key => $country)
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td><img src="{{asset('storage/images/study-abroad/education_system_images/'.$country->education_system_image)}}" alt=""></td>
                                                ...
                                                <td>
                                                    <a  class="btn btn-sm  btn-outline-success" href="{{route('study-abroad.edit',$country->id)}}" title="Edit" ><i class="mdi mdi-lead-pencil"></i></a>
                                                    <button  class="btn btn-sm btn-outline-danger" onclick="deleteFunction({{$country->id}})" title="Delete"><i class="mdi mdi-close"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
