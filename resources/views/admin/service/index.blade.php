            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        Manage Services
                        <button class="btn btn-outline-primary btn-xs float-right" onclick="window.location.href='{{route('service.create')}}';" data-toggle="tooltip" data-placement="bottom"  title="Create Service"> <i class="icon-plus"></i> </button>
